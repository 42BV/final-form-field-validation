...
printf -- '\033[32m Now go to your test project set the version of "@42.nl/final-form-field-validation" to "%s" then run "npm install --registry http://localhost:4873" \033[0m\n' $version
